...
export function ChatCheckScene() {
  return (
    <svg viewBox="0 0 64 48" className="h-11 w-16 text-text-muted" {...strokeProps}>
...
export function DeskBookScene() {
  return (
    <svg viewBox="0 0 96 72" className="h-[72px] w-[108px] text-text-muted" {...strokeProps}>
...
export function PencilAccent() {
  return (
    <svg viewBox="0 0 40 20" className="h-6 w-11 text-text-muted" {...strokeProps}>
...
export function BookStackScene() {
  return (
    <svg viewBox="0 0 56 32" className="h-9 w-16 text-text-muted" {...strokeProps}>
...
export function TrendUpAccent() {
  return (
    <svg viewBox="0 0 40 24" className="h-7 w-11 text-text-muted" {...strokeProps}>
